...
Camera::Camera(const Camera& other): m_posX(0.f), m_posY(0.f), m_posZ(0.f), m_rotX(0.f), m_rotY(0.f), m_rotZ(0.f){
}
...
void Camera::Render(){
	...
	XMVECTOR lookAtXm = XMVectorAdd(XMLoadFloat3(&lookAt), XMLoadFloat3(&pos));
	XMStoreFloat3(&lookAt, lookAtXm);
